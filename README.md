...
- View all stored properties in a structured format  
...
- Work with structured data and collections  
- Implement CRUD operations (Create, Read, Update, Delete)  
- Organise program logic for practical applications  
- Apply programming concepts to simulate a real-world management system  
